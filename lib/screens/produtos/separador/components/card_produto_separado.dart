...
class CardProdutoSeparado extends StatefulWidget {
  ...
  @override
  _CardProdutoSeparadoState createState() => _CardProdutoSeparadoState();
}

class _CardProdutoSeparadoState extends State<CardProdutoSeparado> {
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      onDismissed: (DismissDirection direction) {
        widget.separacaoController.removerProduto(
          widget.produtoHelper,
        );
        Get.back();
        audioCache.play('musics/remover.mp3').then(
              (value) => Get.back(),
            );
      },
      child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      "QTD. SEPARADA:\t\t${widget.produtoHelper.qtdsep ?? ""}",
